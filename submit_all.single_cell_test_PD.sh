...
# load the txt file
txt_file_path="/project/cssp_brazil/mcs_tracking_HG/CPM_PD_TRACKS/unique_cells"
...
EXTRACTOR="/data/users/hgilmour/cold-core-filtering/submit_single_cell_test_PD.sh"

# Set the output directory for the lOTUS OUTPUT
# Set up the output directory
OUTPUT_DIR="/project/cssp_brazil/mcs_tracking_HG/lotus_output/filter_PD_interp"
mkdir -p $OUTPUT_DIR
...
mask_dir="/project/cssp_brazil/mcs_tracking_HG/CPM_PD_TRACKS/segmentation"
...
precip_dir="/project/cssp_brazil/mcs_tracking_HG/data/cpm_PD/total_precip/annual_files/regridded"
precip_file="regridded_total_precip_${year}.nc"

tracks_dir="/project/cssp_brazil/mcs_tracking_HG/CPM_PD_TRACKS/init_tracks"
tracks_file="tracks_${year}_${month}_INTERP.h5"

tb_dir="/project/cssp_brazil/mcs_tracking_HG/data/cpm_PD/tb/annual_files_hrly/regridded"
tb_file="regridded_tb_${year}.nc"

w_dir="/project/cssp_brazil/mcs_tracking_HG/data/cpm_PD/omega/annual_files/regridded"
